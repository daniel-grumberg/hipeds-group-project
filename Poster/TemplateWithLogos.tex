...
%----------------------------------------------------------------------------------------
%
{\sf\bf Camera Poster (logos)} % Poster title
{\vspace{1em} Camera People\\ % Author names
...
Maecenas placerat hendrerit mollis. Nunc fringilla sollicitudin pulvinar. Vestibulum a odio arcu. 
}
...
\headerbox{Choice of Hardware}{name=methods,column=0,below=introduction}{
...
\headerbox{Difficulties?}{name=conclusion,column=0,below=methods}{
	
	 (not sure, maybe mention large data, need for multiple angles, etc.)
...
Powercrust, maybe the ICP as well? I've left the example bibtex file
...
\headerbox{Procedure Overview (bullet points)}{name=results1,span=2,column=1,row=0}{
...
\headerbox{Procedure illustration (include pictures)}{name=results2,span=2,column=1,below=results1,above=bottom}{ % To reduce this block to 1 column width, remove 'span=2'
